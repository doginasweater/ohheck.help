...
export default class NewSurvey extends React.Component<any, NewSurveyState> {
    ...
    addQuestion = event => {
        ...
        this.setState({
            questions: [...this.state.questions, new Question({ id: this.state.questions.length + 1 })]
        });
    }
                ...
                <form className="pure-form pure-form-stacked">
                    <fieldset>
                        ...
                        <label htmlFor="comments">
                            ...
                            This box <b>does</b> accept html.
                        </label>
                        <textarea name="comments" value={this.state.comments} onChange={this.handleChange} className="pure-u-1" />
                    ...
                    <fieldset>
                        ...
                        <div className="breathing-room">
                            ...
                            <button onClick={this.addQuestion} className="pure-button button-primary">Add a new question</button>
                        </div>
                    </fieldset>
                </form>
            </div>
