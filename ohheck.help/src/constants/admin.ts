...
export const SUBUNIT_FETCH = 'SUBUNIT_FETCH';
export const SUBUNIT_FETCH_FULFILLED = 'SUBUNIT_FETCH_FULFILLED';
...
export const IDOL_FETCH = 'IDOL_FETCH';
export const IDOL_FETCH_FULFILLED = 'IDOL_FETCH_FULFILLED';
...
export const SETTINGS_FETCH_FULFILLED = 'SETTINGS_FETCH_FULFILLED';
export const SETTINGS_UPDATE = 'SETTINGS_UPDATE';
export const SETTINGS_UPDATE_FULFILLED = 'SETTINGS_UPDATE_FULFILLED';
export const UPDATE_AKI_PAGE = 'UPDATE_AKI_PAGE';
